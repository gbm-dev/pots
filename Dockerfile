...
# Copy prebuilt slmodemd/d-modem binaries from local bin/
COPY bin/slmodemd /usr/local/bin/slmodemd
COPY bin/d-modem /usr/local/bin/d-modem
RUN chmod +x /usr/local/bin/slmodemd /usr/local/bin/d-modem
